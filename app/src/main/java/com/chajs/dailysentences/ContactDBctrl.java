...
public class ContactDBctrl {
    ...
    public static final String SQL_SELECT_ALL_DATA = "SELECT ID, KEYWORD, KOR_SENTENCE, ENG_SENTENCE, START_DATE, END_DATE, POPUP_TIME, IFNULL(SUCCESS_COUNT,'0'), IFNULL(FAIL_COUNT,'0'), IFNULL(SKIP_COUNT,'0'), IFNULL(SUCCESS_COUNT,'0')*5 + IFNULL(FAIL_COUNT,'0')*-1 + IFNULL(SKIP_COUNT,'0')*-2 AS 'RATI'  FROM " + TABLE_NAME + " ORDER BY RATI DESC";
    //Noti 시간
    ...
    public static final String SQL_SELECT_NOTI_DATA = "SELECT ID, KEYWORD, KOR_SENTENCE, ENG_SENTENCE, START_DATE, END_DATE, POPUP_TIME, IFNULL(SUCCESS_COUNT,'0'), IFNULL(FAIL_COUNT,'0'), IFNULL(SKIP_COUNT,'0'), IFNULL(SUCCESS_COUNT,'0')*5 + IFNULL(FAIL_COUNT,'0')*-1 + IFNULL(SKIP_COUNT,'0')*-2 AS 'RATI'  FROM " + TABLE_NAME +
